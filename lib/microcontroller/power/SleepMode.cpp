...
void SleepMode::enable() {
    ...
    void SleepMode::attachWakeInterruptors() {
        ...
        On purpose compile-time error to remember to attach your wake up interrupts here
    }

    void SleepMode::detachWakeInterruptors() {
        On purpose compile-time error to remember to detach your wake up interrupts here
    }
