...
Temperature Thermistor::readTemperatureC() {
    /* Empirical calibration factor derived from comparing this specific sensor setup
    against a reference thermometer under identical conditions.

    This corrects system-level bias (sensor tolerance, resistor error, placement effects).
    It is NOT related to the thermistor model (Beta or Steinhart-Hart) itself.
    
    Not transferable between setups. Recalibrate if hardware or environment changes. */
